...
<html lang="en">
    ...
    <body>
        ...
        <table width='700' height='222' border='0' align='center' cellpadding='5' cellspacing='0'>
            ...
            <tr>
                <td align='center' valign='middle' style='color:#000; font-size:18px; font-weight:bold'>Pedido de Inscripción</td>
            </tr>
            <tr>
        ...
        <h3>Tu pedido de inscripción se envió con exito a nuestra base de datos, una vez verifiquemos la autenticidad del comprobante enviado, tu Nickname aparecerá en la lista de competidores del evento inscrito.</h3>
        <br>
