...
class InscriptionsController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $evento = Event::where('id',$data->event_id)->first();

        if ($original_data->status != $data->status) {
            if ($data->status == 0) {
